...
class ListServicesViewModelProfile @AssistedInject constructor(
    ...
    override fun getDataFlow(): Flow<PagingData<Service>> {
        return searchLive.asFlow()
            .flatMapLatest {
                servicesRepository.getPagedUserServices(userId)
            }.cachedIn(viewModelScope)
    }

    @AssistedFactory
    interface Factory {
        fun create(filterParams: FilterParamsServices, userId: String): ListServicesViewModelProfile
    }
