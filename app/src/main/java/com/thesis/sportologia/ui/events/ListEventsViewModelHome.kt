...
class ListEventsViewModelHome @AssistedInject constructor(
    ...
    override fun getDataFlow(): Flow<PagingData<EventDataEntity>> {
        return searchLive.asFlow()
            .flatMapLatest {
                ...
                eventsRepository.getPagedUserSubscribedOnEvents(userId, isUpcomingOnlyLiveData.value!!)
            }.cachedIn(viewModelScope)
    }

    @AssistedFactory
    interface Factory {
        fun create(filterParams: FilterParamsEvents, userId: String): ListEventsViewModelHome
    }
