...
class ServiceNotAcquiredFragment : BaseFragment(R.layout.fragment_service_not_acquired) {
    ...
    private fun initListeners(serviceFullItem: ServiceFullItem) {
    ...
    private fun renderService(serviceFullItem: ServiceFullItem) {
        renderGeneralInfo(serviceFullItem)
    }

    private fun renderGeneralInfo(serviceFullItem: ServiceFullItem) {
        ...
        setDescription(serviceFullItem.description)
        ...
        setFavs(serviceFullItem.isFavourite)
        setPhotos(serviceFullItem.photosUrls)
    }
    ...
    private fun setServiceType(serviceType: Service.ServiceType) {
