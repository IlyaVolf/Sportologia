...
## Проект неактуален!
Этот проект не завершен, и в этом репозитории работы по завершению этого проекта вестись не будут.

Тем не менее, этот репозиторий может быть полезен для ознакомления с функционалом приложения и используемыми технологиями.

На данный момент я переписываю проект с нуля, и этот проект будет уже завершён в другом репозитории (как минимум до окончания работ он будет закрыт).
